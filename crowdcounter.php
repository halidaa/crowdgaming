...
if(isset($_REQUEST['key']) && isset($_REQUEST['data'])) {
        ...
        // 5. add a row for session_id if it does not exist, or update the timestamp of the row with the provided session_id if it does exist
